...
<html lang="es">
	<head>
		...
		<title>Comercial San Pablo - Solomillo</title>
		...
		<section id="main">
			...
			<article id="producto">
				...
				<div id="contenido-producto">
					<div id="cont-empresa">
					<div id="borde"></div>
						<p><b>Envasado:</b> Sellado al Vacío o bolsas de polietileno, de 2 a 6 Kg.</p>
						<p><b>Origen:</b> Nacional, Americana o Canadiense.</p>
						<p><b>Presentación:</b> Congelada.</p>
						<p><b>Temperatura Almacenamiento:</b> Almacenamiento: Mantener refrigerada entre -4°C y +4°C.</p>
						<p><b>Comentarios:</b> 4% de grasa visible.</p>						
						<div id="categoria">
							Cerdo
						</div>
					</div>
