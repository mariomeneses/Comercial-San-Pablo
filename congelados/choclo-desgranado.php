...
<html lang="es">
	<head>
		...
		<title>Comercial San Pablo - Choclo Desgranado</title>
	...
	<body>
		...
		<section id="main">
			<article id="botones">
				...
				<a href="productos"><div id="btn-cat"><div id="texto-btn">congelados</div></div></a>
			</article>
			<article id="article">
				<div>Productos&nbsp;&#62;&nbsp;Congelados</div>
				<aside>
					<nav>
						<ul>
							<div id="title_corte">&nbsp;Cortes</div>
							<li><a href="arvejas"><h2 class="seo">&nbsp;&#62;&nbsp;Arvejitas</h2></a></li>
							<li><a href="choclo-desgranado"><h2 class="seo">&nbsp;&#62;&nbsp;Choclo Desgranado</h2></a></li>
							<li><a href="jardinera"><h2 class="seo">&nbsp;&#62;&nbsp;Jardinera</h2></a></li>
							<li><a href="papas-prefritas"><h2 class="seo">&nbsp;&#62;&nbsp;Papas Prefritas</h2></a></li>
							<li><a href="poroto-verde"><h2 class="seo">&nbsp;&#62;&nbsp;Poroto Verde Corte Francés</h2></a></li>
						</ul>
					</nav>
				</aside>
			</article>
			<article id="producto">
				...
				<div id="contenido-producto">
					<div id="cont-empresa">
					<div id="borde"></div>
						<p><b>Marca interAgro.</b></p>
						<p><b>Envasado:</b> Bolsas de 2kg. O cajas de 10 kg.</p>
