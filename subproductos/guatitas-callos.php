...
<html lang="es">
	<head>
		...
		<title>Comercial San Pablo - Guatitas Callo</title>
		...
		<section id="main">
			...
			<article id="producto">
				...
				<div id="contenido-producto">
					<div id="cont-empresa">
					<div id="borde"></div>
						<p><b>Envasado:</b> Según requerimientos del cliente.</p>
						<p><b>Origen:</b> Nacional o canadiense.</p>
						<p><b>Presentación:</b> Fresca o Congelado.</p>
						<p><b>Temperatura Almacenamiento:</b> Mantener refrigerada entre -2°C y +6°C.</p>
						<p><b>Comentarios:</b> Carne vacuna, con 7% de grasa visible.</p>
						<div id="categoria">
							Subproductos
						</div>
					</div>
