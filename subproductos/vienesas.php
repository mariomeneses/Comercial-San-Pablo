...
<html lang="es">
	<head>
		...
		<title>Comercial San Pablo - Vienesas</title>
	...
	<body>
		...
		<section id="main">
			...
			<article id="article">
				<div>Productos&nbsp;&#62;&nbsp;Subproductos</div>
				<aside>
					<nav>
						<ul>
							<div id="title_corte">&nbsp;Cortes</div>
							<li><a href="arrollado-individual-familiar"><h2 class="seo">&nbsp;&#62;&nbsp;Arrollados Individual o Familiar</h2></a></li>
							<li><a href="chorizos-parrilleros"><h2 class="seo">&nbsp;&#62;&nbsp;Chorizos Parrilleros</h2></a></li>
							<li><a href="guatitas-callos"><h2 class="seo">&nbsp;&#62;&nbsp;Guatitas Callos</h2></a></li>
							<li><a href="hamburguesas-100"><h2 class="seo">&nbsp;&#62;&nbsp;Hamburguesas X 100 gramos</h2></a></li>
							<li><a href="hamburguesas-50"><h2 class="seo">&nbsp;&#62;&nbsp;Hamburguesas X 55 gramos</h2></a></li>
							<li><a href="huesos-carnudos"><h2 class="seo">&nbsp;&#62;&nbsp;Huevos</h2></a></li>
							<li><a href="jamon-sandwich"><h2 class="seo">&nbsp;&#62;&nbsp;Jamón Sandwich</h2></a></li>
							<li><a href="jamon-pavo"><h2 class="seo">&nbsp;&#62;&nbsp;Jamón de Pavo</h2></a></li>
							<li><a href="longaniza"><h2 class="seo">&nbsp;&#62;&nbsp;Longaniza</h2></a></li>
							<li><a href="vienesas"><h2 class="seo">&nbsp;&#62;&nbsp;Vienesas</h2></a></li>
						</ul>
					</nav>
				</aside>
			</article>
			<article id="producto">
				...
				<div id="contenido-producto">
					<div id="cont-empresa">
					<div id="borde"></div>
						<p><b>Envasado:</b> Envases de 1 kg o 25 unidades.</p>
						<p><b>Origen:</b> Nacional (Ariztia o Superpollo).</p>
						<p><b>Presentación:</b> Selladas al vacío.</p>
						<p><b>Temperatura Almacenamiento:</b> Almacenamiento: entre  +4°C y -4°C.</p>
						<p><b>Comentarios:</b> CCon resolución sanitaria vigente.10% grasas saturadas.</p>
						<div id="categoria">
							Subproductos
						</div>
					</div>
