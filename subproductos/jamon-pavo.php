...
<html lang="es">
	<head>
		...
		<title>Comercial San Pablo - Jamón de Pavo</title>
		...
		<section id="main">
			...
			<article id="producto">
				...
				<div id="contenido-producto">
					<div id="cont-empresa">
					<div id="borde"></div>
						<p><b>Envasado:</b> Laminado, al vacío según requerimientos.</p>
						<p><b>Origen:</b> Nacional (San Jorge o similar).</p>
						<p><b>Presentación:</b> Laminas de 20 grs. c/u tipo Budapest.</p>
