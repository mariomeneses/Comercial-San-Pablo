...
<html lang="es">
	<head>
		...
		<title>Comercial San Pablo - Pechuga Importada S/Hueso</title>
	...
	<body>
		...
		<section id="main">
			...
			<article id="article">
				<div>Productos&nbsp;&#62;&nbsp;Ave</div>
				<aside>
					<nav>
						<ul>
							<div id="title_corte">&nbsp;Cortes</div>
							<li><a href="pechuga-entera"><h2 class="seo">&nbsp;&#62;&nbsp;Pechuga Pollo Fresca Entera</h2></a></li>
							<li><a href="pechuga-sin-hueso"><h2 class="seo">&nbsp;&#62;&nbsp;Pechuga Pollo Fresca S/Hueso</h2></a></li>
							<li><a href="pechuga-importada"><h2 class="seo">&nbsp;&#62;&nbsp;Pechuga Pollo Importada S/Hueso</h2></a></li>
							<li><a href="pechuga-pavo-deshuesada"><h2 class="seo">&nbsp;&#62;&nbsp;Pechuga Pavo Deshuesada</h2></a></li>
							<li><a href="pollos-enteros"><h2 class="seo">&nbsp;&#62;&nbsp;Pollos Enteros</h2></a></li>
							<li><a href="tutos-enteros-pollo"><h2 class="seo">&nbsp;&#62;&nbsp;Tutos Enteros Pollo</h2></a></li>
							<li><a href="tutos-corto-pollo"><h2 class="seo">&nbsp;&#62;&nbsp;Tutos Cortos Pollo</h2></a></li>
						</ul>
					</nav>
				</aside>
			</article>
			<article id="producto">
				<div id="titulo-producto">
					Pechuga Importada S/Hueso
				</div>
				<div id="contenido-producto">
					<div id="cont-empresa">
					<div id="borde"></div>
						<p><b>Envasado:</b> En envase de polietileno.</p>
						<p><b>Origen:</b> Súper pollo o similar.</p>
						<p><b>Presentación:</b> Congelada o fresca según requerimiento.</p>
						<p><b>Temperatura Almacenamiento:</b> Mantener refrigerada entre -4°C y +4°C.</p>
						<p><b>Comentarios:</b> Consumir antes de 10 días, máximo 6% materia grasa. Unidades enteras, deshuesadas con o sin cuero.</p>
						<div id="categoria">
							Ave
						</div>
					</div>
